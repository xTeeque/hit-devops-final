...
public class MaxLimitSimulation extends Simulation {
    ...
    private static final int START_RATE  = Integer.getInteger("start.rate", 10);
    private static final int STEP_RATE   = Integer.getInteger("step.rate", 10);
    private static final int STEPS       = Integer.getInteger("steps", 12);
